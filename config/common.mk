...
ifdef EVOLUTION_BUILD_EXTRA
    EVOLUTION_POSTFIX := -$(EVOLUTION_BUILD_EXTRA)
endif
ifndef EVOLUTION_BUILD_TYPE
    EVOLUTION_BUILD_TYPE := UNOFFICIAL
    PLATFORM_VERSION_CODENAME := UNOFFICIAL
    EVOLUTION_POSTFIX := -$(shell date +"%Y%m%d-%H%M")
endif

# Set all versions
EVOLUTION_VERSION := Evolution-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(EVOLUTION_BUILD_TYPE)$(EVOLUTION_POSTFIX)
EVOLUTION_MOD_VERSION := Evolution-$(EVOLUTION_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(EVOLUTION_BUILD_TYPE)$(EVOLUTION_POSTFIX)

PRODUCT_PROPERTY_OVERRIDES += \
    BUILD_DISPLAY_ID=$(BUILD_ID) \
    evolution.ota.version=$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE) \
    ro.evolution.version=$(EVOLUTION_VERSION) \
    ro.modversion=$(EVOLUTION_MOD_VERSION)
